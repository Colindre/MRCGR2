...
#CANVAS TKINTER
        self.canvas = tk.Canvas(self, bg='white', width=1500, height=800)
        self.canvas.pack()
...
#BOUTTONS TKINTER
        ...
        self.PlusVg = tk.Button(self, text='+ Vd', command=self.robot.augDPSg)
        self.PlusVg.pack(side='right')
        self.DimVg = tk.Button(self, text='- Vd', command=self.robot.dimDPSg)
        self.DimVg.pack(side='right')
        self.PlusVd = tk.Button(self, text='+ Vg', command=self.robot.augDPSd)
        self.PlusVd.pack(side='left')
        self.DimVd = tk.Button(self, text='- Vg', command=self.robot.dimDPSd)
